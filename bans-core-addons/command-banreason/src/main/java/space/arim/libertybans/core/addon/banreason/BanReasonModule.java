...
public final class BanReasonModule extends AddonBindModule {

	@MultiBinding
	public Addon<?> banReasonAddon(BanReasonAddon banReasonAddon) {
		return banReasonAddon;
	}

	@MultiBinding
	public SubCommandGroup banReasonCommand(BanReasonCommand banReasonCommand) {
		return banReasonCommand;
	}
}
